<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">Pending Lab Orders</h2>
    </x-slot>
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
            ...
            <div class="bg-white p-6 shadow-sm sm:rounded-lg">
                <form method="GET" class="flex gap-3">
                    ...
                    <a href="{{ route('labtech.completed') }}" class="px-4 py-2 bg-indigo-600 text-white rounded-md text-sm font-semibold uppercase">Completed</a>
                </form>
            </div>
                    ...
                    <tbody class="divide-y divide-gray-200">
                        @forelse($orders as $order)
                            <tr>
                                ...
                                <td class="px-6 py-4 text-sm"><a href="{{ route('labtech.enter-results', $order->id) }}" class="text-indigo-600 hover:text-indigo-900">Enter Results</a></td>
                            </tr>
                        @empty
                            <tr><td colspan="6" class="px-6 py-6 text-center text-gray-500 text-sm">No pending orders.</td></tr>
                        @endforelse
                    </tbody>
                </table>
